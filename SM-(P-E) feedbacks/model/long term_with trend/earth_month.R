...
##########################################
CAN<-list.files('/rigel/glab/users/sz2766/paper_four/model/data/EC-EARTH/',pattern='.nc',full.names=TRUE)
###################01#####################
nc<-nc_open(CAN[1])
v1<-nc$var[[2]]
...
ncout<-nc_create(paste('/rigel/glab/users/sz2766/paper_four/model/out/PLSR_trend/EC-EARTH/earth_plsr_month_',

...
##########################################
CAN<-list.files('/rigel/glab/users/sz2766/paper_four/model/data/IPSL/',pattern='.nc',full.names=TRUE)
###################01#####################
nc<-nc_open(CAN[1])
v1<-nc$var[[1]]
lhc<-ncvar_get(nc,v1)
...
ncout<-nc_create(paste('/rigel/glab/users/sz2766/paper_four/model/out/PLSR_trend/IPSL/ipsl_plsr_month_',
